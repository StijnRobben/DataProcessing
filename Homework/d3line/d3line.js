...
d3.json("JanuaryData.json", function(error, json) {
...
var svg = d3.select("body").append("svg")
  ...
  x.domain(d3.extent(January, function(d) { return d.DateJan; }));
  y.domain(d3.extent(January, function(d) { return d.MaxJan; }));
  ...
  svg.append("path")
   ...
   var tooltip = d3.select("body")
    ...
    var ydomain = d3.extent(January, function(d) { return d.MaxJan; });
